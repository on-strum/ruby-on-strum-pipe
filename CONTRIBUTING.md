...
3. `on_strum-pipe` [issue template](.github/ISSUE_TEMPLATE/issue_report.md)/[bug template](.github/ISSUE_TEMPLATE/bug_report.md)
...
1. `on_strum-pipe` [pull request template](.github/PULL_REQUEST_TEMPLATE.md)
